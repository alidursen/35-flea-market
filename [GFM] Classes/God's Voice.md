...
| --  | --                 | --         | --        | --         | --                       | --  | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1   | +0                 | +2         | +0        | +2         | Domains, Godly Spark     | 3   | 0+1 | --- | --- | --- | --- | --- | --- | --- | --- |
| 2   | +1                 | +3         | +0        | +3         |                          | 3   | 1+1 | --- | --- | --- | --- | --- | --- | --- | --- |
| 3   | +2                 | +3         | +1        | +3         |                          | 4   | 1+1 | 0+1 | --- | --- | --- | --- | --- | --- | --- |
| 4   | +3                 | +4         | +1        | +4         | Third Domain             | 4   | 1+2 | 1+1 | --- | --- | --- | --- | --- | --- | --- |
| 5   | +3                 | +4         | +1        | +4         |                          | 5   | 1+2 | 1+1 | 0+1 | --- | --- | --- | --- | --- | --- |
| 6   | +4                 | +5         | +2        | +5         | Leadership               | 5   | 1+2 | 1+2 | 1+1 | --- | --- | --- | --- | --- | --- |
| 7   | +5                 | +5         | +2        | +5         |                          | 6   | 1+3 | 1+2 | 1+1 | 0+1 | --- | --- | --- | --- | --- |
| 8   | +6/+1              | +6         | +2        | +6         |                          | 6   | 1+3 | 1+2 | 1+2 | 1+1 | --- | --- | --- | --- | --- |
| 9   | +6/+1              | +6         | +3        | +6         |                          | 6   | 1+3 | 1+3 | 1+2 | 1+1 | 0+1 | --- | --- | --- | --- |
| 10  | +7/+2              | +7         | +3        | +7         | Fourth Domain            | 7   | 1+3 | 1+3 | 1+2 | 1+2 | 1+1 | --- | --- | --- | --- |
| 11  | +8/+3              | +7         | +3        | +7         |                          | 7   | 1+3 | 1+3 | 1+3 | 1+2 | 1+1 | 0+1 | --- | --- | --- |
| 12  | +9/+4              | +8         | +4        | +8         |                          | 7   | 1+3 | 1+3 | 1+3 | 1+2 | 1+2 | 1+1 | --- | --- | --- |
| 13  | +9/+4              | +8         | +4        | +8         |                          | 8   | 1+4 | 1+3 | 1+3 | 1+2 | 1+2 | 1+1 | 0+1 | --- | --- |
| 14  | +10/+5             | +9         | +4        | +9         |                          | 8   | 1+4 | 1+3 | 1+3 | 1+2 | 1+2 | 1+2 | 1+1 | --- | --- |
...
unless their deity is also neutral, in which case they *must* be neutral.
...
god's voice gets the granted powers of both the domains selected.

At 4th and 10th levels, a god's voice picks additional domains. These are subject to the
same restrictions and grant the same benefits of domain powers and accessible spells.

**Domains and additional proficiencies**: Some domains grant additional proficiencies
and class skills as part of their domain powers. These are reproduced below for convenience.
...
a chaotic good voice of a neutral good god has a strong good aura, while a chaotic
...
However, their alignment may restrict them from casting certain spells
opposed to their moral or ethical beliefs; see Chaotic, Evil, Good, and
Lawful Spells, below. A god's voice must choose and prepare their spells in
advance (see below).

To prepare or cast a spell, a god's voice must have a Wisdom score equal to
at least 10 + the spell level. The Difficulty Class for a saving throw
against a voice's spell is 10 + the spell level + the voice's Wisdom
modifier.
...
allotment of spells. Time spent resting has no effect on whether a god's voice
can prepare spells. A god's voice may prepare and cast any spell on their spell
...
For example, a lawful good voice of a lawful neutral god cannot cast
Evil spells, while a lawful neutral voice of the same god could. Neither
of them could cast Chaotic spells.

**Bonus Languages**: A god's voice's bonus language options include
...
(see the *geas/quest* spell description) to test their newfound faith.

When a god's voice start speaking for other gods, their followers gained by
the Leadership feat depart, on a base ratio of 10% and increased by 20% for
...
If a god's voice simply loses access to divine abilities due to a violation
